...
export const getMustMatchVariantContent = (variant: SchemaOfTypes) => {
  const content: Record<SchemaOfTypes, IVariantContent> = {
    allOf: {
      fill: "bg-emerald-50 border-emerald-300 dark:bg-emerald-200 dark:border-emerald-400",
    ...
    anyOf: {
      fill: "bg-sky-50 border-sky-300 dark:bg-sky-200 dark:border-sky-400",
    ...
    oneOf: {
      fill: "bg-violet-50 border-violet-300 dark:bg-violet-200 dark:border-violet-400",
    ...
    not: {
      fill: "bg-red-50 border-red-300 dark:bg-red-200 dark:border-red-400",
    ...
    additionalProperties: {
      fill: "bg-teal-50 border-teal-200 dark:bg-teal-200 dark:border-teal-400",
